...
namespace WindowsFormsApp1
{
    partial class Form_apply4
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_apply4));
            ...
            this.cmb_BH_blood.Items.AddRange(new object[] {
            "阳性",
            "阴性"});
            ...
            this.cmb_tuberculosis.Items.AddRange(new object[] {
            "阳性",
            "阴性"});
            ...
            this.cmb_syphilis.Items.AddRange(new object[] {
            "阳性",
            "阴性"});
            ...
            this.cmb_hepatitisC.Items.AddRange(new object[] {
            "阳性",
            "阴性"});
            ...
            this.cmb_hepatitisB.Items.AddRange(new object[] {
            "阳性",
            "阴性"});
            ...
            this.cmb_narcosis_way.Items.AddRange(new object[] {
            "一级",
            "二级",
            "三级",
            "特级"});
            ...
            this.cmb_cut_grade.Items.AddRange(new object[] {
            "Ⅰ",
            "Ⅱ",
            "Ⅲ"});
            ...
            this.cmb_body_position.Items.AddRange(new object[] {
            "仰卧位",
            "侧卧位",
            "俯卧位",
            "膀胱截石位",
            ...
            "经⽪静脉内溶栓术",
            "经皮选择性动脉造影术（不含脑及冠脉）",
            "经⽪选择性动脉置管术（包括各种药物治疗、栓塞）",
            "经皮静脉内滤⽹置⼊术",
            "经⽪超选择性动脉造影术",
            "⼼内电⽣理检查",
            "临时起搏器植⼊术",
            "经⽪静脉内⽀架置⼊术",
            "经⽪动脉⽀架置⼊术（包括肢体动脉、颈动脉、肾功脉）",
            "经皮动脉激光成形+球囊扩张术",
            "经⽪瓣膜球囊成形术（包括⼆尖瓣、三尖瓣、主动脉瓣、肺动脉瓣膜成形术、房间隔⼿",
            "剥术）",
            "经⽪⼼内膜⼼肌活检术（不含病理诊断及其它特殊检查）",
            "先⼼性介⼊治疗（包括动脉导管未闭、房间隔缺损）",
            "冠状动脉造影术",
            "经⽪冠状动脉内溶栓术",
            "射频消融术（不包括房颤）",
            "永久起搏器置⼊术（不包括 ICD）",
            "经皮⼤动脉⽀架植⼊术（包括腹主动脉、假性动脉瘤）",
            "经⽪冠状动脉腔内成形术（PTCA）",
            "经⽪冠状动脉内⽀架置⼊术（STENT）",
            "经⽪冠状动脉腔内激光成形术",
            "冠状动脉内膜旋磨术",
            ...
            this.cmb_ss_grade.Items.AddRange(new object[] {
            "一级",
            "二级",
            "三级",
            "特级"});
